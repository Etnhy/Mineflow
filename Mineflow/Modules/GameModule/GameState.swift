...
extension GameState {
    static let testState: GameState = {
        ...
        state.board[1][1] = Cell(row: 1, col: 1, isMine: false, surroundingMines: 0, isOpened: true)
        ...
        state.board[2][1] = Cell(row: 2, col: 1, isMine: false, surroundingMines: 0, isOpened: true)
        ...
        state.board[5][0] = Cell(row: 5, col: 0, isMine: true, surroundingMines: 0, isOpened: true)
        state.board[5][1] = Cell(row: 5, col: 1, isMine: true, surroundingMines: 0, isOpened: false, flagState: .flagged)
        state.board[5][2] = Cell(row: 5, col: 2, isMine: false, surroundingMines: 0, isOpened: false, flagState: .questionMarked)

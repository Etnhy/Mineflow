...
//        let rows = CGFloat(state.gameModel.rows)
//
//        // (Ячейки * размер) + (Промежутки * кол-во) + (Отступы * 2)
//        let width = (cols * constantCellSize) + (max(0, cols - 1) * cellSpacing) + (padding * 2)
//        let height = (rows * constantCellSize) + (max(0, rows - 1) * cellSpacing) + (padding * 2)
//
//        return CGSize(width: width, height: height)
...
//                theme: theme,
//                cellSpacing: cellSpacing,
//                padding: padding, cellSize: constantCellSize,
//                finalRadius: finalRadius,
//                finalFontSize: finalFontSize,
//                finalImageSize: finalImageSize,
//                send: send
...
//                    .onEnded { value in
//                        finalScale *= value
//                        finalScale = max(0.5, min(finalScale, 3.5))
//                    }
//            )
//        }
//
...
//        switch state.gameModel.gameMode {
//        case .easy:
//            return isSmallDevice ? 18 : 22
//        case .medium:
//            return isSmallDevice ? 16 : 18
//        case .hard:
//            return isSmallDevice ? 12 : 14
//        }
//    }
//
//    private func cellImageSize() -> CGFloat {
//        switch state.gameModel.gameMode {
//        case .easy:
//            return isSmallDevice ? 30 : 35
//        case .medium:
//            return isSmallDevice ? 15 : 20
//        case .hard:
//            return isSmallDevice ? 12 : 15
//
//        }
//    }
//
